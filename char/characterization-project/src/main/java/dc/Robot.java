...
public class Robot extends TimedRobot {
  ...
  static private int ENCODER_EDGES_PER_REV = 1;
  static private int PIDIDX = 0;
  static private int kTimeoutMs = 30;
  static private int filterWindowSize = 1;
  ...
  public void robotInit() {
    ...
    master = new WPI_TalonSRX(8);
    master.setInverted(true);
    master.setSensorPhase(false);
    master.setNeutralMode(NeutralMode.Brake);

    WPI_TalonSRX slave0 = new WPI_TalonSRX(7);
    ...
    master.configPulseWidthPeriod_EdgesPerRot(
      ENCODER_EDGES_PER_REV, kTimeoutMs
    );
    master.configPulseWidthPeriod_FilterWindowSz(
      filterWindowSize, kTimeoutMs
    );

    encoderPosition = ()
        -> master.getSelectedSensorPosition(PIDIDX) * encoderConstant/1024;
    encoderRate = ()
